...
vim.keymap.set('n', '<A-m>', lz.make, { noremap = true, silent = true })
vim.keymap.set('n', '<A-t>', lz.todo, { noremap = true, silent = true })
...
vim.keymap.set('n', '<A-S-0>', function() vim.cmd('edit 0.md') end, { noremap = true, silent = true })
vim.keymap.set('n', '<A-S-t>', function() vim.cmd('edit 0b.md') end, { noremap = true, silent = true })
vim.keymap.set('n', '<A-S-j>', function() vim.cmd('edit 0d.md') end, { noremap = true, silent = true })
vim.keymap.set('n', '<A-S-r>', function() vim.cmd('edit r.md') end, { noremap = true, silent = true })
vim.keymap.set('n', '<A-S-w>', function() vim.cmd('edit w.md') end, { noremap = true, silent = true })
