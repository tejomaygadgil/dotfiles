...
vim.keymap.set({ 'n', 'v' }, '<leader>ga', ':Git commit --amend<CR>')
vim.keymap.set({ 'n', 'v' }, '<leader>gA', ':Gitsigns stage_hunk<CR>:Git commit --amend<CR>')
vim.keymap.set({ 'n', 'v' }, '<leader>gs', ':Gitsigns stage_hunk<CR>')
vim.keymap.set({ 'n', 'v' }, '<leader>gS', ':Gitsigns stage_hunk<CR>:Git commit<CR>')
