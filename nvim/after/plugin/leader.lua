...
vim.keymap.set('n', '<leader>ci', function() vim.cmd('edit $DOTFILES/nvim/init.vim') end)
vim.keymap.set('n', '<leader>cl', function() vim.cmd('edit $DOTFILES/nvim/lua/tej/lazy.lua') end)
vim.keymap.set('n', '<leader>cr', function() vim.cmd('edit $DOTFILES/home/.bash_aliases') end)
vim.keymap.set('n', '<leader>c<leader>', function() vim.cmd('edit $DOTFILES/nvim/after/plugin/leader.lua') end)
